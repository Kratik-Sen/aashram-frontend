...
const StockIssues = () => {
  ...
  const loadData = async (showLoader = true, page = 1, append = false) => {
    ...
    try {
      const [issueRes, itemRes, departmentRes] = await Promise.all([
        api.get("/issues", { params: withPagination(filters, page) }),
  ...
  useRealtimeRefresh(["issues", "items", "departments"], () => loadData(false));
    ...
    <div className="space-y-5">
      ...
      <section className="panel overflow-hidden">
        <DataTable
          ...
          data={issues}
          loading={loading}
          emptyTitle="No stock issues found"
          emptyMessage="Issue stock to departments or adjust filters."
